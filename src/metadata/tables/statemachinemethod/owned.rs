...
pub struct StateMachineMethod {
    ...
    ///
    /// We use strong references (MethodRc) instead of weak references because:
    /// - State machine mappings don't create circular dependencies
    /// - We want to ensure methods stay alive as long as the mapping exists
    /// - The mapping is unidirectional and safe from memory leaks
    ///
