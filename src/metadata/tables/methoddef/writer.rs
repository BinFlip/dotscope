...
mod tests {
    ...
    fn test_flags_truncation() {
        ...
        let large_flags_row = MethodDefRaw {
            ...
            offset: 0,
            rva: 0x2000,
            impl_flags: 0x12345678, // Large value that should truncate to 0x5678
            flags: 0x87654321,      // Large value that should truncate to 0x4321
            name: 0x100,
            signature: 0x200,
            param_list: 1,
        };
        ...
        assert_eq!(deserialized_row.impl_flags, 0x5678); // Truncated value
        assert_eq!(deserialized_row.flags, 0x4321); // Truncated value
    }
}
