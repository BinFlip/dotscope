...
use crate::{
    ...
    metadata::{
        ...
        streams::{
            ...
            MethodImplMap, MethodSemanticsMap, MethodSpecMap, ModuleRc, ModuleRefMap,
            NestedClassMap, ParamMap, PropertyMap, PropertyMapEntryMap, StandAloneSigMap, Strings,
            TableId, TablesHeader, TypeSpecMap, UserStrings,
        },
