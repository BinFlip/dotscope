...
mod tests {
    ...
    fn owned_type_dependency_validator_file_factory() -> crate::Result<Vec<TestAssembly>> {
        ...
        // These would test:
        // - Unresolved base type dependencies
        // - Broken interface dependency references
        // - Missing method parameter type dependencies
        // - Unresolved nested type dependencies
        // - Circular dependency detection in dependency graphs

        Ok(assemblies)
    }

    #[test]
    fn test_owned_type_dependency_validator() -> crate::Result<()> {
        let validator = OwnedTypeDependencyValidator::new();
