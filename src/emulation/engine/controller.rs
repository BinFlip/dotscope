...
use crate::{
    ...
    metadata::{
        ...
        tables::{MemberRefSignature, StandAloneSignature},
        token::Token,
...
impl EmulationController {
    ...
    fn handle_call(
        ...
        match default_behavior {
            UnknownMethodBehavior::Emulate => {
                ...
                if method.body.get().is_some() && has_instructions {
    ...
    fn handle_newobj(
        ...
        if constructor_token.table() == 0x0A {
        ...
        if let Some(ref decl_type) = declaring_type {
            ...
            .with_internal(constructor_token.table() == 0x06);
        ...
        let has_instructions = method.instructions().next().is_some();
        if !hook_handled && method.body.get().is_some() && has_instructions {
