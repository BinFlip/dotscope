...
pub struct CilInstruction<'a> {
    /// The `OperantType` of this instruction
    ...
    /// Stack push modifier
    pub stack_pushes: u8,
    /// `ControlFlow` indicator for this instruction
    pub flow: FlowType,
}

/// Maximum opcode value for single byte instructions
...
/// Maximum opcode value for two byte instructions
