...
use crate::{
    ...
    metadata::{
        method::MethodModifiers, signatures::TypeSignature, tables::MemberRefSignature,
        token::Token, typesystem::CilTypeReference,
    },
    ...
    fn resolve_call_info(assembly: &CilObject, token: Token) -> Option<(usize, bool, bool)> {
        match token.table() {
            ...
            0x06 => {
                ...
                let has_this = !method.flags_modifiers.contains(MethodModifiers::STATIC);
