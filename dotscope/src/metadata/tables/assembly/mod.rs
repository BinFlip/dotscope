...
pub struct HashAlgorithmId(pub u32);
...
impl fmt::Display for HashAlgorithmId {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self.0 {
            ...
            0x8003 => write!(f, "MD5"),
            0x8004 => write!(f, "SHA1"),
            0x800C => write!(f, "SHA256"),
            0x800D => write!(f, "SHA384"),
            0x800E => write!(f, "SHA512"),
            other => write!(f, "0x{other:08X}"),
        }
    }
}

impl From<u32> for HashAlgorithmId {
    fn from(v: u32) -> Self {
        Self(v)
    }
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct AssemblyFlagsValue(pub u32);

impl fmt::Display for AssemblyFlagsValue {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl From<u32> for AssemblyFlagsValue {
    fn from(v: u32) -> Self {
        Self(v)
    }
}

newtype_ops!(HashAlgorithmId, u32);
newtype_ops!(AssemblyFlagsValue, u32);
